...
public:
	...
	void updateAll(cVector3d a_pos, cVector3d a_euler, double a_xErr, double a_zErr, double a_yawErr, double a_rollErr, double a_X1, double a_Y1, double a_X2, double a_Y2);
	void setConstraints();
